...
public class HmPhyRecordRequest implements Serializable {
	...
	public String toString() {
		return "HmPhyRecordRequest [guid=" + guid + ", usrguid=" + usrguid + ", reporttype=" + reporttype
