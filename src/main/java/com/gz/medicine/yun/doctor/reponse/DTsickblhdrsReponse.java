 ...
 * @version V1.0
 * @Author fendo
 * @ClassName DTsickblhdrsReponse
 * @PackageName com.gz.medicine.yun.doctor.reponse
 * @Description 病历
 * @Data 2017-08-18 10:35
 **/
public class DTsickblhdrsReponse implements Serializable {
    ...
    private List<DTsickbldtlResponse> medication;
    ...
    public List<DTsickbldtlResponse> getMedication() {
        return medication;
    }

    public void setMedication(List<DTsickbldtlResponse> medication) {
        this.medication = medication;
    }

    public DTsickblhdrsReponse() {
    }
}
