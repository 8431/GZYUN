...
public class HealthPushMessageReponse implements Serializable {
     ...
     */
        ...
        private String consultationmethodname;
...
//					String str = sdf.format(pushtime);
    ...
    public String getConsultationmethodname() {
        return consultationmethodname;
    }

    public void setConsultationmethodname(String consultationmethodname) {
        this.consultationmethodname = consultationmethodname;
    }
}
